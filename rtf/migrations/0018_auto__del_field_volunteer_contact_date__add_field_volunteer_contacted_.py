...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Volunteer.contacted_date'
        db.add_column(u'rtf_volunteer', 'contacted_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'Volunteer.contacted'
        db.alter_column(u'rtf_volunteer', 'contacted', self.gf('django.db.models.fields.NullBooleanField')(null=True))
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Volunteer.contacted_date'
        db.delete_column(u'rtf_volunteer', 'contacted_date')


        # Changing field 'Volunteer.contacted'
        db.alter_column(u'rtf_volunteer', 'contacted', self.gf('django.db.models.fields.BooleanField')())
