...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Volunteer.contacted_by'
        db.add_column(u'rtf_volunteer', 'contacted_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Volunteer.contacted_by'
        db.delete_column(u'rtf_volunteer', 'contacted_by_id')
    ...
    models = {
        ...
        u'rtf.volunteer': {
            ...
            'contacted_by': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True'}),
