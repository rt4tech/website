...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Chapter.email'
        db.alter_column(u'rtf_chapter', 'email', self.gf('django.db.models.fields.EmailField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'Chapter.email'
        db.alter_column(u'rtf_chapter', 'email', self.gf('django.db.models.fields.EmailField')(default='NA', max_length=255))
