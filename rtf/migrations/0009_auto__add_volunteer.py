...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'rtf_volunteer', (
            ...
            ('communications', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('design', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('development', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('multimedia', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('organizing', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('other', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
        ))
        db.send_create_signal(u'rtf', ['Volunteer'])


    def backwards(self, orm):
        # Deleting model 'Volunteer'
        db.delete_table(u'rtf_volunteer')
